...
return [
     ...
     */
    'from' => [
        'address' => getenv('MAILGUN_FROM_NAME'),
        'name'    => getenv('MAILGUN_FROM_ADDRESS'),
    ],
     ...
     *
     */
    'reply_to' => getenv('MAILGUN_REPLY_TO'),

    /*
     * Mailgun (private) API key
     *
     */
    'api_key' => getenv('MAILGUN_SECRET_KEY'),

    /*
     * Mailgun public API key
     *
     */
    'public_api_key' => getenv('MAILGUN_API_KEY'),
     ...
     *
     */
    'force_from_address' => getenv('MAILGUN_FORCE_FROM_ADDRESS'),
     ...
     */
    'catch_all' => getenv('MAILGUN_CATCH_ALL'),
     ...
     */
    'testmode' => getenv('MAILGUN_TEST_MODE'),
];
